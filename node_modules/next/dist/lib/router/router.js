...
var Router = function () {
  function Router(pathname, query) {
    ...
    if (typeof window !== 'undefined') {
      ...
      this.replace((0, _url.format)({ pathname: pathname, query: query }), getURL());
  ...
  (0, _createClass3.default)(Router, [{
    ...
    value: function onPopState(e) {
      ...
      _promise2.default.resolve().then((0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee() {
        ...
        var _ref4 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(err) {
          var data, ctx, props;
    ...
    key: 'reload',
    value: function () {
      var _ref5 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee3(route) {
