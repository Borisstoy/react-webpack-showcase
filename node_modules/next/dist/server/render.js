      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            _context3.next = 12;
            return _promise2.default.all([Component.getInitialProps ? Component.getInitialProps(ctx) : {}, (0, _read2.default)((0, _path.join)(dir, '.next', 'bundles', 'pages', page)), (0, _read2.default)((0, _path.join)(dir, '.next', 'bundles', 'pages', dev ? '_error-debug' : '_error'))]);
          ...
          case 19:
            ...
            _context3.next = 22;
            return Document.getInitialProps((0, _extends3.default)({}, ctx, { renderPage: renderPage }));
...
var renderJSON = exports.renderJSON = function () {
  var _ref9 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee4(res, page) {
    ...
    return _regenerator2.default.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return (0, _read2.default)((0, _path.join)(dir, '.next', 'bundles', 'pages', page));

          case 2:
            component = _context4.sent;

            sendJSON(res, { component: component });
  ...
  return function renderJSON(_x18, _x19) {
    return _ref9.apply(this, arguments);
  };
}();

var renderErrorJSON = exports.renderErrorJSON = function () {
  var _ref11 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee5(err, res) {
    ...
    return _regenerator2.default.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            page = err && dev ? '/_error-debug' : '/_error';
            _context5.next = 3;
            return (0, _read2.default)((0, _path.join)(dir, '.next', 'bundles', 'pages', page));
  ...
  return function renderErrorJSON(_x21, _x22) {
...
function renderErrorToHTML(err, req, res, pathname, query) {
  ...
  var page = err && opts.dev ? '/_error-debug' : '/_error';
  return doRender(req, res, pathname, query, (0, _extends3.default)({}, opts, { err: err, page: page }));
}
